...
public class GemabungaBlock extends DoublePlantBlock implements SimpleWaterloggedBlock {
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

	public GemabungaBlock() {
		super(BlockBehaviour.Properties.of().mapColor(MapColor.WATER).sound(SoundType.GRASS).instabreak().hasPostProcess((bs, br, bp) -> true).emissiveRendering((bs, br, bp) -> true).lightLevel(s -> 9).noCollission().ignitedByLava()
	...
	public static void blockColorLoad(RegisterColorHandlersEvent.Block event) {
		...
		}, UndertaleModBlocks.ECHOFLOWER.get());
	}
}