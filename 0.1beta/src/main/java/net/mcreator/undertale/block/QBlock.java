...
public class QBlock extends SaplingBlock {
	public static final TreeGrower TREE_GROWER = new TreeGrower("q", Optional.of(getFeatureKey("undertale:waterfalldampwood")), Optional.of(getFeatureKey("undertale:waterfalldampwood")), Optional.of(getFeatureKey("undertale:waterfalldampwood")));
	...
	public boolean mayPlaceOn(BlockState groundState, BlockGetter worldIn, BlockPos pos) {
		return groundState.is(UndertaleModBlocks.WATERFALLGRESS.get()) || groundState.is(UndertaleModBlocks.WATERFALLDIRT.get());
	}
