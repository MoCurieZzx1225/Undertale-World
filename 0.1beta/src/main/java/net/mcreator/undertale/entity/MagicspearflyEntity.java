package net.mcreator.undertale.entity;
...
import net.mcreator.undertale.init.UndertaleModEntities;

import javax.annotation.Nullable;

@OnlyIn(value = Dist.CLIENT, _interface = ItemSupplier.class)
public class MagicspearflyEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(UndertaleModItems.MAGICSPEAR_0.get());
	private int knockback = 0;

	public MagicspearflyEntity(EntityType<? extends MagicspearflyEntity> type, Level world) {
		super(type, world);
	}

	public MagicspearflyEntity(EntityType<? extends MagicspearflyEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public MagicspearflyEntity(EntityType<? extends MagicspearflyEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	protected ItemStack getDefaultPickupItem() {
		return new ItemStack(UndertaleModItems.MAGICSPEAR_0.get());
	}
	...
	public static MagicspearflyEntity shoot(Level world, LivingEntity entity, RandomSource source) {
		return shoot(world, entity, source, 0.6f, 6, 1);
	}

	public static MagicspearflyEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 0.6f, 6, 1);
	}

	public static MagicspearflyEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		MagicspearflyEntity entityarrow = new MagicspearflyEntity(UndertaleModEntities.MAGICSPEARFLY.get(), entity, world, null);
	...
	public static MagicspearflyEntity shoot(LivingEntity entity, LivingEntity target) {
		MagicspearflyEntity entityarrow = new MagicspearflyEntity(UndertaleModEntities.MAGICSPEARFLY.get(), entity, entity.level(), null);
